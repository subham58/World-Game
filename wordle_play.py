...
print("If the letter is of GREEN color: it means that the letter is in the word and is in correct position")
print("If the letter is of YELLOW color: it means that the letter is in the word but in the wrong spot")
print("If the letter is of WHITE color: it means that the letter is not in the word on any spot")
